...
class CartServiceImplTest {
    ...
    void shouldGetCartItemListFromCart() {
        ...
        final List<Product> productList = Arrays.asList(
                new Product(1L, "image1", "name1", 50, 4, "Description1",
                        5, Type.WEIGHABLE, 1, ProductCategory.FRUITS, 1000),
                new Product(2L, "image2", "name2", 40, 3, "Description2",
                        6, Type.WEIGHABLE, 1, ProductCategory.FRUITS, 1000)
        );
        ...
        CartDto actualDto = cartService.getCartItems("adamsmith@yahoo.com");

        assertThat(actualDto.getCartItemList()).containsExactlyInAnyOrderElementsOf(expectedDtoList);
    }

    @Test
    void shouldReturnAnEmptyCartWhenUserDoesNotExistsItemListFromCart() {
        final User user = new User("adamsmith@yahoo.com", "12345", Role.USER);
        ...
        assertThat(actualDto.getCartItemList()).containsExactlyInAnyOrderElementsOf(new ArrayList<>());
    }
    ...
    void shouldAddItemsToCard() {
        ...
        ProductDtoShort productDtoShort1 = new ProductDtoShort(
                1L, "image1", "name1", 50.0, 4.0, Type.WEIGHABLE, 1);
        ProductDtoShort productDtoShort2 = new ProductDtoShort(
                2L, "image2", "name2", 40.0, 3.0, Type.WEIGHABLE, 1);

        CartItemDto cartItemDto1 = new CartItemDto();
        cartItemDto1.setProductDtoShort(productDtoShort1);
        cartItemDto1.setQuantity(3);

        CartItemDto cartItemDto2 = new CartItemDto();
        cartItemDto2.setProductDtoShort(productDtoShort2);
        cartItemDto2.setQuantity(5);
        ...
        cartService.addItemsToCard(cartDto, "adamsmith@yahoo.com");
